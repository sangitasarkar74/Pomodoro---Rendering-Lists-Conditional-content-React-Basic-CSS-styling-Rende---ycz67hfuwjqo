  ...
  return (
    <div className="App" style={{ textAlign: "center" }}>
      ...
      <div className='control'>
        <button data-testid='start-btn' key='start' onClick={() => { setFlag(true); setResetFlag(false) }} disabled={flag} >start</button>
        <button data-testid='stop-btn' key='stop' onClick={() => { setFlag(false); setResetFlag(false) }} disabled={!flag}>Stop</button>
